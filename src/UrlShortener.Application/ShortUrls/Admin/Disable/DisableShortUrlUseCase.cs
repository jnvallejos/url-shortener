...
public sealed class DisableShortUrlUseCase
{
    private readonly IShortUrlRepository _repo;
    private readonly IDomainEventDispatcher _dispatcher;

    public DisableShortUrlUseCase(
    ...
    public async Task<Result<DisableShortUrlResponse>> ExecuteAsync(
        DisableShortUrlRequest request,
        CancellationToken ct)
    {
        ...
        return new DisableShortUrlResponse(shortUrl.ShortCode.ToString(), shortUrl.IsEnabled);
    }
}
